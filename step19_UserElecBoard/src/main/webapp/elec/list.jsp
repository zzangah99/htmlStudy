...
<!-- 
	<nav class="pagination-container">
		<div class="pagination">
			<a class="pagination-newer" href="${path}/front?key=elec&methodName=select&pageNo=${pageNo>1?pageNo-1:1}">PREV</a> 
				<span class="pagination-inner"> 
			...
			<a class="pagination-older" href="${path}/front?key=elec&methodName=select&pageNo=${pageNo<pageCnt?pageNo+1:pageCnt}">NEXT</a>
		</div>
	</nav> 
 -->
 ...
 <nav class="pagination-container">
		<div class="pagination">
		<c:set var="doneLoop" value="false"/><!-- true일 때는 반복문을 빠져나오게 함 -->
